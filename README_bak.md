...
[![img](https://img.shields.io/badge/license-Apache%202.0-dark)](https://gitee.com/equant/equant/blob/master/LICENSE) [![img](https://img.shields.io/badge/python-%3E=3.7.x-green.svg)](https://python.org/) [![PyPI - Django Version badge](https://img.shields.io/badge/django%20versions-4.0-blue)](https://docs.djangoproject.com/zh-hans/4.0.4/) [![img](https://img.shields.io/badge/node-%3E%3D%2016.0.0-brightgreen)](https://nodejs.org/zh-cn/) [![img](https://gitee.com/equant/equant/badge/star.svg?theme=dark)](https://gitee.com/equant/equant) [![GitHub stars](https://img.shields.io/github/stars/equant/equant.svg?theme=dark&label=Github)](https://github.com/equant/equant)
...
- 文档地址: [数据大屏 | equant](http://124.222.210.96/document/sjdp.html)
...
- 文档地址：[代码生成器 | equant](http://124.222.210.96/document/generator.html)
...
💡 [equant-web](https://gitee.com/equant/equant/tree/master/web) 采用 VUE3，TS 开发。 💡 [equant-backend](https://gitee.com/equant/equant/tree/master/backend) 采用 Python，Django 和 Django-Ninija 开发。数据库支持MySql，SqlServer，Sqlite。
...
|        | 项目地址                            |
| ------ | ----------------------------------- |
| github | https://github.com/equant/equant |
| 码云   | https://gitee.com/equant/equant  |
...
```bash
# 克隆项目
git clone https://gitee.com/equant/equant.git
...
# 或使用 daphne :
daphne -b 0.0.0.0 -p 8000 equant.asgi:application
```
